        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeBonuses_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeBonuses_AspNetUsers_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProblemCause = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DeliveredById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRequests_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_AspNetUsers_DeliveredById",
                        column: x => x.DeliveredById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_AspNetUsers_SpecialistId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_Customers_CustomerId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_Devices_DeviceId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_ServiceRequests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestNotes_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeBonuses_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestNotes_CreatedById",
                table: "RequestNotes",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_CustomerId1",
                table: "ServiceRequests",
                column: "CustomerId1");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_DeliveredById",
                table: "ServiceRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_DeviceId1",
                table: "ServiceRequests",
                column: "DeviceId1");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_SpecialistId",
                table: "ServiceRequests",
                column: "SpecialistId");
        }
